...
public class AnnotationPolymorphismArrayTest {
    ...
    public static final String ARRAY_EXPECTED = "[[\"dog\",{\"isDog\":true}],[\"cat\",{\"isCat\":true}],[\"dog\","
            + "{\"isDog\":true}]]";
    ...
    public void testUnknownAliasDeserialization() {
        JsonbException exception = assertThrows(JsonbException.class,
                                                () -> Jsonbs.defaultJsonb.fromJson("[\"rat\",{\"isRat\":false}]", Animal.class));
    ...
    public void testUnknownAliasSerialization() {
        ...
        assertThat(exception.getMessage(),
                   is("Could not find proper alias for class: "
                              + "org.eclipse.yasson.customization.polymorphism.AnnotationPolymorphismArrayTest$Rat"));
    }
    ...
    @PolymorphicType(format = PolymorphicType.Format.WRAPPING_ARRAY)
    ...
    @PolymorphicType(keyName = "@dateType", format = PolymorphicType.Format.WRAPPING_ARRAY)
